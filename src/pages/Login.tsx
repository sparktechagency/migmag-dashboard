    ...
    <div className="flex  justify-between w-full h-full ">
      ...
      <div className="bg-[#e1e95d] ">
        ...
        <h3 className="text-[40px] font-bold">
          Power up your platform and keep the <br /> music flowing.
        </h3>
        <p>
          Monitor songs, manage purchases, and handle users with ease. Your
          complete toolkit to keep <br /> the music business running smoothly.
        </p>
      </div>
      <div className="">
        <AuthWrapper className="rounded-2xl shadow-[_0px_30px_30px_30px_rgba(249,_250,_229,_20)]">
